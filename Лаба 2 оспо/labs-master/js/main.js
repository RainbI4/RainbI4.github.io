	...
	var trigger=0, name, age, sex, education, mathematic, asu, cutting, programming; // обьявляем переменные которые понадобятся в ходе работы
		...
		((document.getElementById("asu").checked ==true) && (document.getElementById("mathematic").checked == true) ||
		(document.getElementById("asu").checked == true) && (document.getElementById("cutting").checked = true) || 
		(document.getElementById("asu").checked == true) && (document.getElementById("programming").checked == true) ||
		(document.getElementById("mathematic").checked == true) && (document.getElementById("cutting").checked == true) ||
		(document.getElementById("mathematic").checked == true) && (document.getElementById("programming").checked == true) ||
		(document.getElementById("cutting").checked == true) && (document.getElementById("programming").checked == true)))
		{
